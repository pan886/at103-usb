...
#ifndef UNITY_EXCLUDE_SETJMP_H
extern int  riscv_setjmp(jmp_buf __env);
extern void riscv_longjmp(jmp_buf __jmpb, int __retval) __attribute__ ((__noreturn__));
#define TEST_PROTECT() (riscv_setjmp(Unity.AbortFrame) == 0)
#define TEST_ABORT() riscv_longjmp(Unity.AbortFrame, 1)
#else
