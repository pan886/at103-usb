 ...
 *   [Note] To block the execution of Master commands, set the TX_CMD_BLOCK bit only when Tx FIFO is empty ( STATUS[2]=1) and the master is in the Idle state ( STATUS[5] == 0).
 ...
 * @param[in] NewState New state of the specified I2C interrupts.
 *   This parameter can be: ENABLE or DISABLE.
 *
 */
 ...
 * @param[in] I2Cx Shere x can be 1 or 2 to select the I2C peripheral.
 ...
 * @return I2C_ModuleEnable_Status: The new state of I2C_ModuleEnable_Status (SET or RESET).
 */
 ...
 * @return I2C_BusStatus: The new state of I2C_BusStatus (SET or RESET).
 */
...
/**
 * @brief This function indicates the number of Tx FIFO data commands that are flushed due to TX_ABRT interrupt. It is cleared whenever I2C is disabled.
 * @param[in] I2Cx Where x can be 1 or 2 to select the I2C peripheral.
